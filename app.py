...
def update_bc_bar(map_depth, variable):
    ...
    return fig.update_layout(margin=dict(t=30, b=50), height=400)
...
def update_bc_map(map_depth, variable):
    ...
    return fig.update_layout(coloraxis_showscale=False, margin=dict(t=30, b=50, r=0, l=0), height=550,
                             mapbox_bounds={"west": 110, "east": 130, "south": -30, "north": 40})
